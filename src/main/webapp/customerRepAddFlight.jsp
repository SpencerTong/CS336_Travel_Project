...
<title>Add Flights for a Customer</title>
</head>
<body>
<form action="customerRepUI.jsp" method="get">
	<input type="submit" value="Back To Customer Rep UI">
</form>
	<h3>Enter Customer ID to Search Flights</h3>
    <form method="post">
...
%>
    ...
    try {
		...
		out.println("<h4>Searching for flights to purchase for user with CID: " + cid + "</h4>");
    	                ...
    	                <tr>
    	                    ...
    	                    <td><%= basicPrice %>
    	                    	<form method="POST">
    	                    		...
    	                    		<input type="hidden" name="cidInput" value="<%= cid %>">
